...
import 'package:tutorial_app/schedules/timezone.dart';
import 'package:tutorial_app/screen/mentees.dart';
...
class DatePickerState extends State<DatePicker> {
  ...
  Future _sNotification(DateTime scheduledTime, int id) async {
    var androidDetails = new AndroidNotificationDetails(
        "1", "Schedule", "ScheduleNotificationChannel",
    ...
    fltrNotification.zonedSchedule(
        counter, "Schedule", alarms[id][4], st, generalNotificationDetails,
